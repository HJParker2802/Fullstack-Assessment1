...
VALUES("Abandonment of child under two","C");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Giving false statements to procure cremation","I");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Burglary (domestic)","E");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Burglary (non-domestic)","E");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Abduction of woman by force","J");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Forgery of driving documents","H");
INSERT INTO tbl_ViolationTypes(ViolationName, ViolationClass)
VALUES("Armed robbery","B");
...
VALUES (1, 'Mississippi State');
INSERT INTO tbl_Person(DriversLicenseID, Forename, Surname, Address, State, ZipCode, City, DOB, Height,  Weight, EyeColour, PhoneNum)
VALUES(1,"Ryan","Graham","30367 Alvarez Motorway","Mississippi State", "57843", "West Laurenfort", "2001-11-14","6.1" ,"113.2", "Grey", "07968178644");

-- Person 2
INSERT INTO tbl_DriversLicense (DriversLicenseID, DriversLicenseOrigin)
VALUES (2, 'Indiana');
INSERT INTO tbl_Person(DriversLicenseID, Forename, Surname, Address, State, ZipCode, City, DOB, Height,  Weight, EyeColour, PhoneNum)
VALUES(2,"Rose","Davis","566 Peterson Skyway Apt. 948","Indiana State", "12346", "Coxton", "1934-12-19","6.4" ,"52.2", "Blue", "07549552762");

-- Person 3
INSERT INTO tbl_DriversLicense (DriversLicenseID, DriversLicenseOrigin)
VALUES (3, 'Texas');
INSERT INTO tbl_Person(DriversLicenseID, Forename, Surname, Address, State, ZipCode, City, DOB, Height,  Weight, EyeColour, PhoneNum)
VALUES(3,"Denise","Carter","723 Phillips Tunnel Suite 779","Texas State", "06724", "North Steve", "1984-02-16","6.3" ,"92.4", "Brown", "07226683061");

-- Person 4
INSERT INTO tbl_DriversLicense (DriversLicenseID, DriversLicenseOrigin)
VALUES (4, 'Kansas');
INSERT INTO tbl_Person(DriversLicenseID, Forename, Surname, Address, State, ZipCode, City, DOB, Height,  Weight, EyeColour, PhoneNum)
VALUES(4,"John","Morgan","79850 Jermaine Burgs Apt. 950","Kansas State", "30767", "Dianaview", "1961-09-19","6.6" ,"63.8", "Grey", "07990673772");

-- Person 5
INSERT INTO tbl_DriversLicense (DriversLicenseID, DriversLicenseOrigin)
VALUES (5, 'Oklahoma');
INSERT INTO tbl_Person(DriversLicenseID, Forename, Surname, Address, State, ZipCode, City, DOB, Height,  Weight, EyeColour, PhoneNum)
VALUES(5,"Michele","Sharp","04820 Nicole Points Apt. 978","Oklahoma State", "76305", "Kristenberg", "1992-04-26","5.2" ,"56.8", "Blue", "07529054736");
...
=================================
*/
-- Creating violations from officer 1 and 3
INSERT INTO tbl_Violations(OfficerID, ViolationTypeID, Location, District, ViolationDate, ViolationTime, ViolatorID)
VALUES(1,7,"Texas","County Sheriffs Office", "12/03/1950", "16:42:59",2);
INSERT INTO tbl_Violations(OfficerID, ViolationTypeID, Location, District, ViolationDate, ViolationTime, ViolatorID)
VALUES(1,1,"Oklahoma","Oklahoma City Police Department", "27/06/2003", "11:27:48",3);
INSERT INTO tbl_Violations(OfficerID, ViolationTypeID, Location, District, ViolationDate, ViolationTime, ViolatorID)
VALUES(1,5,"Kansas","Kansas City Police Department", "29/08/1998", "07:28:32",4);
INSERT INTO tbl_Violations(OfficerID, ViolationTypeID, Location, District, ViolationDate, ViolationTime, ViolatorID)
VALUES(1,1,"Texas", "County Sheriffs Office", "03/02/1996", "14:56:12",3);

INSERT INTO tbl_Violations(OfficerID, ViolationTypeID, Location, District, ViolationDate, ViolationTime, ViolatorID)
VALUES(2,4,"Indiana","Indianapolis Metropolitan Police Department (IMPD)", "13/05/2000", "18:32:47",2);



/*
Making VehiclesMakes
=====================================
*/
-- Populating vehicles with set options 
INSERT INTO tbl_VehicleMake(VehicleName ,DriveType, VehicleManual, VehicleBrand,CarWeight, VehicleYear)
VALUES("Toyota Corolla", "FWD", false, "Toyota", 1290, 2019);
INSERT INTO tbl_VehicleMake(VehicleName, DriveType, VehicleManual, VehicleBrand, CarWeight, VehicleYear)
VALUES("BMW M3", "RWD", true, "BMW", 1725, 2020);
INSERT INTO tbl_VehicleMake(VehicleName, DriveType, VehicleManual, VehicleBrand, CarWeight, VehicleYear)
VALUES("Ford F-150", "AWD", false, "Ford", 2040, 2021);
...
VALUES("JTN-4821", "Texas", "Red", 1, "30367 Alvarez Motorway",1 );
INSERT INTO tbl_Vehicles(VehicleLicense, VehicleState, VehicleColour, VehicleMakeID, VehicleAddress, VehicleOwner)
VALUES("7KZP310", "Indiana", "Green", 2, "566 Peterson Skyway Apt. 948",2 );
INSERT INTO tbl_Vehicles(VehicleLicense, VehicleState, VehicleColour, VehicleMakeID, VehicleAddress, VehicleOwner)
VALUES("TXR-5M82", "Mississippi", "Orange", 3, "30367 Alvarez Motorway",5 );
...
-- CREATE USER 'Civillian'@'%' IDENTIFIED BY 'CivillianPassword';
...
-- GRANT SELECT, INSERT, UPDATE ON FullstackDevelopment_Assignment1.tbl_Violations TO 'Officer'@'%'; -- Allows officers to selecct, insert and update, but not delete 
...
-- -- ALlows the Civillians to view violations but nothing else 
-- GRANT SELECT ON FullstackDevelopment_Assignment1.tbl_Violations TO 'Civillian'@'%';
...
-- Query 7:Count of violations per officer over the past 25 months
